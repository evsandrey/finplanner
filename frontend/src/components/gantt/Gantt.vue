<template>
  <div class="wrapper">
    <div class="header">
      ...
      <p>
        Use <strong>grid-column</strong> to span a new entry across the grid.
        (e. g. <strong>grid-column: 5/12;</strong> spans an entry from May to
        November)
      </p>
    </div>
    <div class="gantt">
      ...
      <div class="gantt__row gantt__row--lines" data-month="5">
        ...
        ><span></span> <span></span><span class="marker"></span><span></span>
      ...
      <div class="gantt__row">
        ...
        <ul class="gantt__row-bars">
          <li style="grid-column: 4/11; background-color: #2ecaac;">
            Even longer project
          </li>
        </ul>
      </div>
      ...
      <div class="gantt__row">
        ...
        <ul class="gantt__row-bars">
          ...
          <li
            style="grid-column: 1/6; background-color: #ff6252;"
            class="stripes"
          ></li>
          <li style="grid-column: 7/11; background-color: #54c6f9;">
            Same line
          </li>
        </ul>
      </div>
      ...
      <div class="gantt__row">
        ...
        <ul class="gantt__row-bars">
          <li style="grid-column: 3/8; background-color: #54c6f9;">
            Long project
          </li>
        </ul>
      </div>
      ...
      <div class="gantt__row">
        ...
        <ul class="gantt__row-bars">
          <li
            style="grid-column: 4/9; background-color: #ff6252;"
            class="stripes"
          >
            A title
          </li>
